...
export const Chart14 = () => {
  ...
  if (province === "China") {
    for (let i = 0; i < 9; i++) {
      displayNumber[i] =
        cache.baoding.defectiveReason[i] +
        cache.chengdu.defectiveReason[i] +
        cache.xian.defectiveReason[i] +
        cache.shanghai.defectiveReason[i];
    }
  } else {
    ...
    <table className={"chart-14"}>
      ...
      <tbody>
        <tr>
          ...
          <td rowSpan={3}>
            {displayNumber[0] + displayNumber[1] + displayNumber[2]}
          </td>
        </tr>
        <tr>
          <td>机床加工程序错误</td>
        ...
        <tr>
          ...
          <td rowSpan={3}>{displayNumber[3] + displayNumber[4] + displayNumber[5]}</td>
        </tr>
        <tr>
          <td>加工参数异常</td>
        ...
        <tr>
          ...
          <td rowSpan={3}>{displayNumber[6] + displayNumber[7] + displayNumber[8]}</td>
        </tr>
        <tr>
          <td>传送带异物</td>
